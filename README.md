...
4. **`Ofgem_Archetype`**: Contains information extracted from the report [Ofgem energy consumer archetypes update 2024"][./Ofgem_Energy_Consumer_Archetypes_Update_2024.pdf]. Table 1 of this report is used as a reference for creating consumer archetypes in the residential sector for MUSE, referred to as 'Ofgem_agents'.
